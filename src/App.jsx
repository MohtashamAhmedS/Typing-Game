...
function App() {
  ...
  switch (statusGame) {
    case 'playGame':
      layout = (
        <PlayGame onChangeScore={handleChangeScore} onEndGame={handleEndGame} />
      )
      break
    case 'endGame':
      layout = (
        <EndGame score={score} onGame={handleChangeStatusGame} wpm={wpm} />
      )
      break
    default:
  ...
  return (
    <div className="App">
      <img
        src="https://images4.alphacoders.com/891/891303.jpg"
        alt=""
